...
class Window(Frame):
    ...
    def create_widgets(self):
        ...
        self.dicom_button.grid(row=9, column=1)
    ...
    def run_transform(self, __=0):
        ...
        self.inverse = inverse_radon(self.image, sino, self.n, self.alpha, self.d, self.numberOfThreads, fig, self.is_iterative.get())
        print("***")
