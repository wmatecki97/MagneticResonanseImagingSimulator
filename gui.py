...
class Window(Frame):
    ...
    def create_widgets(self):
        ...
        # variables
        Label(self, text="Alpha").grid(row=2, column=0)
        self.alpha_entry.grid(row=3, column=0)
        Label(self, text="Detectors").grid(row=2, column=1)
        self.n_entry.grid(row=3, column=1)
        Label(self, text="Arc").grid(row=2, column=2)
        self.d_entry.grid(row=3, column=2)

        self.filter_check.grid(row=4, column=1)
        self.iterative_check.grid(row=5, column=1)
